...
std::int16_t cockroachDamage = playerHealth / 6; // 1/10 of total hero health 
...
std::int16_t cockroach_HitByBulletDamage = cockroachHealth / 5;
...
std::int16_t greedZombie_HitByBulletDamage = greedZombieHealth / 7;
