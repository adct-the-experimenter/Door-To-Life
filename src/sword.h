...
public:
    ...
    friend bool loadSwordMedia(SDL_Renderer* gRenderer,LTexture* sTexture, 
                                std::vector <SDL_Rect> &s_walk_clips);
    
    friend void freeSwordMedia(LTexture* sTexture);
...
//Sprite of Sword
    ...
    virtual void render(SDL_Rect& camera, SDL_Renderer* gRenderer, SDL_Rect* clip = NULL); 
